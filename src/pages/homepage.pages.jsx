    ...
    return (
        <div className='flex flex-col items-center mt-10 w-full'>
            ...
            <section className='flex flex-col md:flex-row md:items-center justify-between md:justify-center space-x-10 w-[85%] bg-[#FBFBFB] rounded-[25px] pt-[90px] pb-[30px] px-[40px] mb-10'>
                <img src='/assets/treatmentHome.png' className='md:w-[40%] w-full mb-5 md:mb-0' />
            ...
            <section className='flex flex-col items-center mb-10 w-full'>
                ...
                <div className='flex flex-row flex-wrap items-center justify-center w-full bg-[#FCFCFC] pb-5 ml-5'>
                    ...
                    <img src='/assets/forwardIcon.png' className='hidden xl:flex cursor-pointer hover:scale-75' />
                </div>
                <div className='flex flex-row'>
                    <img src='/assets/backIcon.png' className='xl:hidden cursor-pointer hover:scale-75' />
                    <img src='/assets/forwardIcon.png' className='xl:hidden cursor-pointer hover:scale-75' />
                </div>
            </section>
