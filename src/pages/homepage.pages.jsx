...
const Homepage = () => {
    return (
        <>
            <PageHero>
                <div className='self-start md:ml-[40px]' >
                    <div className='self-start pl-10 md:pl-20 mt-3 md:mt-7 w-full'>
                        <span className='text-white text-[35px] tb:text-[55px] font-bold leading-none'>ALL YOU NEED <br />TO BE EPIC</span>
                        <p className='max-w-[550px] text-[13px] md:text-[16px] text-white mt-2 md:mt-5'>If your skin has started to show wear and tear from sun, aging, acne or other skin conditions there is much that can be done.</p>
                    </div>
                    <div className='flex flex-col flex-wrap  items-center'>
                        ...
                        <div className='flex md:hidden flex-row items-center justify-between w-[50%] mt-3 md:mt-[0px]'>
                            <BsChevronLeft size={25} className='border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons' />
                            <BsChevronRight size={25} className='border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] navigationIcons' />
                        </div>
                    </div>
                </div>
            </PageHero>

            <div className='hidden md:flex flex-row items-center justify-between w-[50%] mt-5'>
                <BsChevronLeft size={25} className='border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons' />
                <BsChevronRight size={25} className='border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] navigationIcons' />
            </div>
            <div className='flex flex-col items-center mt-10 md:mt-[80px] w-full'>
                <section>
                    ...
                    <div className='flex flex-col lg:flex-row items-center'>
                        ...
                        <img src='/assets/Brand5.png' className='hover:shadow-xl hover:mb-[12px] rounded-lg' />
                        <img src='/assets/Brand6.png' className='hover:shadow-xl hover:mb-[12px] rounded-lg pr-3' />
                    </div>
                </section>
                ...
                <section className='mb-[-70px] z-10 flex flex-col items-center w-[100%]'>
                    ...
                    <div className='flex flex-row flex-wrap items-center justify-center'>
                        <div className='flex flex-col items-start w-[250px] md:w-[290px] h-[220px] bg-[#796AB81A] px-5 py-3 rounded-[20px] border-t-[3px] border-t-[#796AB8] shadow-lg cursor-pointer mr-4 mb-4'>
                        ...
                        <div className='flex flex-col items-start w-[250px] md:w-[290px] h-[220px] bg-[#FFFFFF] px-5 py-3 rounded-[20px] border-t-[3px] border-t-[#796AB8] shadow-lg cursor-pointer hover:bg-[#796AB81A] mr-4 mb-4'>
                ...
                <section className='flex flex-col items-center mb-10 w-full'>
                    ...
                    <div className='flex flex-row flex-wrap items-center justify-center w-full bg-[#FCFCFC] pb-5 ml-5'>
                        ...
                        <div className='flex flex-col items-start w-[290px] md:w-[365px] px-3 py-4 bg-[#E1C75C1A] rounded-[20px] border-[1px] border-[#E1C75C] mr-[50px] mb-[30px] shadow-lg'>
                        ...
                        <div className='flex flex-col items-start w-[290px] md:w-[365px] px-3 py-4 bg-[#fff] rounded-[20px] mr-[50px] mb-[30px] shadow-lg'>
                            <img src='/assets/sunScreenSvg.svg' className='h-[100px] md:h-full' />
                            <span className='text-[20px] font-bold'>BIO WATERY SUN CREAM</span>
                            <span className='text-[#C6C6C6] text-[14px]'>SPF50+ PA++++-P</span>
                            <div className='flex flex-row items-center justify-between mt-3 w-full mb-2'>
                        ...
                        <div className='flex flex-col items-start w-[290px] md:w-[365px] px-3 py-4 bg-[#fff] rounded-[20px] mr-[50px] md:mr-[13px] mb-[30px] shadow-lg'>
                            <img src='/assets/sunScreenSvg.svg' className='h-[100px] md:h-full' />
                            <span className='text-[20px] font-bold'>BIO WATERY SUN CREAM</span>
                            <span className='text-[#C6C6C6] text-[14px]'>SPF50+ PA++++-P</span>
                            <div className='flex flex-row items-center justify-between mt-3 w-full mb-2'>
                    ...
                    <div className='flex flex-row'>
                        <BsChevronLeft size={25} className='xl:hidden border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons mr-20' />
                        <BsChevronRight size={25} className='xl:hidden border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons' />
                    </div>
                </section>
                ...
                <section className='w-full flex flex-col items-center'>
                    ...
                    <div className='flex flex-col items-center w-full'>
                        <div className='shadow-lg flex flex-col items-start w-[90%] rounded-[20px] py-4 mb-5'>
                            <div className='flex flex-col md:flex-row justify-between w-full pr-2 items-start'>
                                ...
                                <div className='flex flex-row items-start justify-between w-full'>
                                    <div className='flex flex-col items-start'>
                                        ...
                                        <p className='mb-[50px] md:mb-[100px] text-[16px] md:text-[20px]'>These is the best product I bought so far! I love how they grab color too. So
