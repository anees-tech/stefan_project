...
=======
  ...
  const Slide1 = () => (
    <div className="self-center md:self-start md:ml-[40px]">
      <div className="self-center text-center md:text-start md:self-start  md:pl-20 mt-3 md:mt-7 w-full">
        <span className="text-white text-[35px] tb:text-[55px] font-bold leading-none">
          ALL YOU NEED <br />
          TO BE EPIC
        </span>
        <p className="md:max-w-[550px] text-[17px] md:text-[16px] text-white mt-10 px-4 md:px-[0px] md:mt-5">
      ...
      <div className="w-full flex flex-col items-center justify-center pb-3  px-3 absolute bottom-0">
        <div className="flex  flex-row items-center justify-between space-x-2 mt-[10px] md:mt-[100px] tb:mt-[200px] w-full">
          ...
          <div className="flex flex-row items-center space-x-3">
            <img
              src="/assets/selectedEllipse.png"
              className="border-[1px] border-[#E8C229] border-solid rounded-[50%] p-[2px]"
            />
            <img src="/assets/ellipse.png" />
            <img src="/assets/ellipse.png" />
          </div>
  ...
  const Slide2 = () => (
    <div className="self-center md:self-start md:ml-[40px]">
      <div className="self-center text-center md:text-start md:self-start  md:pl-20 mt-3 md:mt-7 w-full">
        ...
        <p className="md:max-w-[550px] text-[17px] md:text-[16px] text-white mt-10 px-3 md:px-[0px] md:mt-5">
          If your skin has started to show wear and tear from sun, aging, acne
          or other skin conditions there is much that can be done.
        </p>
      </div>
          ...
          {!menuOpen && (
            <a>
              <BsChevronLeft
                ...
                href="#carouselExampleControls"
                data-slide="prev"
                className="carousel-control-prev border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons mobile"
              />
            </a>
          )}
          <div className="flex flex-row items-center space-x-3">
          ...
          {!menuOpen && (
            <a>
              ...
              <BsChevronRight
                ...
                href="#carouselExampleControls"
                data-slide="next"
                className="carousel-control-next border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] navigationIcons mobile"
              />
            </a>
          )}
        </div>
      ...
      <div className="flex flex-col items-center md:mt-[80px] w-full">
          ...
          <div className="flex flex-row overflow-x-auto scrolling-touch scrollbar-hide w-full items-center justify-start tb:justify-center px-4 py-4 bg-[#FCFCFC] pb-5">
            <div className="flex-none md:flex flex-col items-start w-[290px] h-[220px] bg-[#FFFFFF] px-5 rounded-[20px] border-t-[3px] border-t-[#796AB8] shadow-lg cursor-pointer hover:bg-[#796AB81A] mr-4 ">
              ...
              <div className="mt-[-20px]">
                ...
                <p className="text-[14px] text-[#3F3F3F] mt-3">
                  We are focused on bringing affordable, and quality healthcare
                  to your doorstep,
                </p>
              </div>
            </div>
            <div className="flex-none md:flex flex-col items-start w-[290px] h-[220px] bg-[#FFFFFF] px-5 rounded-[20px] border-t-[3px] border-t-[#796AB8] shadow-lg cursor-pointer hover:bg-[#796AB81A] mr-4">
              ...
              <div className="mt-[-20px]">
                ...
                <p className="text-[14px] text-[#3F3F3F] mt-3">
                  Fancy for a walk in central of London, come and visit us to
                  own your look.
                </p>
              </div>
            </div>
            <div className="flex-none md:flex flex-col items-start w-[290px] h-[220px] bg-[#FFFFFF] px-5 rounded-[20px] border-t-[3px] border-t-[#796AB8] shadow-lg cursor-pointer hover:bg-[#796AB81A] mr-4">
              ...
              <div className="mt-[-20px]">
                ...
                <p className="text-[14px] text-[#3F3F3F] mt-3">
                  Our products are available for delivery anywhere in United
                  Kingdom.
                </p>
              </div>
            </div>
        ...
        <section className="flex flex-col md:flex-row items-center justify-between md:justify-center md:space-x-10 w-full md:w-[85%] bg-[#FBFBFB] rounded-[25px] pt-[90px] pb-[30px] px-0 md:px-[40px] mb-10">
          <img
            ...
            className="md:w-[40%] w-[91%] mb-5 md:mb-0 mx-[20px]"
          />
          ...
          <div className="w-full md:w-[60%] w-full pl-4">
            ...
            <p className="mb-20 w-full">
              ...
              treatment you wish and book your favourite day and hour to get it
              done.
              <br /> <br />{" "}
              <span className="font-bold text-[20px]">Note! </span>
              <br /> The treatmts at your house tent to be more expensive then
              in the clinic. For{" "}
              <span className="font-bold">traveling outside of London </span>
              will be <span className="font-bold">additional charges </span> in
              top of the treatment/s price.
            </p>
            <div className="flex flex-row justify-center w-full">
              <button className="bg-gradient-to-r from-[#E1C75C] to-[#C2A013] text-white font-bold text-[19px] w-[325px] py-3 px-3 rounded-lg hover:bg-gradient-to-l ">
                CHECK TREATMENTS
              </button>
            </div>
          </div>
        ...
        <section className=" flex flex-col items-center mb-10 w-full">
          ...
          <div className="flex flex-row items-center justify-center w-fit space-x-3 bg-[#F6F6F6] p-3 px-4 mb-10">
            <button className="bg-[#fff] text-[#9D90D5]  from-[#E1C75C] to-[#C2A013] font-medium text-[18px] md:w-[225px] px-4 py-3 rounded-lg hover:text-white hover:bg-gradient-to-r">
              NEW ARRIVALS
            </button>
            <button className="bg-[#fff]  text-[#9D90D5]  from-[#E1C75C] to-[#C2A013] font-medium text-[18px] md:w-[225px] px-4 py-3 rounded-lg hover:text-white hover:bg-gradient-to-r">
              MOST POPULAR
          ...
          <div className=" flex flex-row overflow-x-auto scrolling-touch scrollbar-hide items-center justify-start tb:justify-center w-full bg-[#FCFCFC] pb-5 px-4">
            <BsChevronLeft
              size={25}
              className="hidden xl:flex border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons mr-3"
            />
...
=======
            <BsChevronRight
              size={25}
              className="hidden xl:flex border-[1px] rounded-[50%] w-[40px] h-[40px] p-2 cursor-pointer hover:border-[#E8C229] hover:text-[#E8C229] navigationIcons ml-3"
            />
          </div>
        </section>
