            ...
            <PageHero background={"url('/assets/homepageHeroSvg.svg')"}>
                <div className='self-start'>
                    <div className='self-start pl-10 md:pl-20 mt-7 w-full'>
                        ...
                        <p className='max-w-[550px] text-[11px] md:text-[16px] text-white mt-5'>If your skin has started to show wear and tear from sun, aging, acne or other skin conditions there is much that can be done.</p>
                    </div>
